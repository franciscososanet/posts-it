...
addBox.addEventListener("click", () => {
    popupTitle.innerText = "Crear nuevo post-it.";
...
function deleteNote(noteId) {
    let confirmDel = confirm("¿Estás seguro de eliminar este post-it?");
...
function updateNote(noteId, title, filterDesc) {
    ...
    popupTitle.innerText = "Modificar post-it";
    addBtn.innerText = "Modificar";
}
